...
def lambda_handler(event, context):
    ...
    transcribeStatus=event["Records"][0]["dynamodb"]["NewImage"]["transcribeStatus"]["S"]
    ...
    if transcribeStatus=="COMPLETED":
        ...
        contactPhoneNumber=event["Records"][0]["dynamodb"]["NewImage"]["contactPhoneNumber"]["S"]
        recordingUrl=event["Records"][0]["dynamodb"]["NewImage"]["recordingUrl"]["S"]
        timestamp=event["Records"][0]["dynamodb"]["NewImage"]["timestamp"]["N"]
        contactId=event["Records"][0]["dynamodb"]["NewImage"]["contactId"]["S"]
        assigneeId=event["Records"][0]["dynamodb"]["NewImage"]["assigneeId"]["S"]
        recordingBucketName=event["Records"][0]["dynamodb"]["NewImage"]["recordingBucketName"]["S"]
        recordingObjectKey=event["Records"][0]["dynamodb"]["NewImage"]["recordingObjectKey"]["S"]
